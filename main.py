...
from routers import ebay as ebay_router
from routers import suppliers as suppliers_router
from routers import eats as eats_router
...
app.include_router(ebay_router.router,      prefix=PREFIX)  # BAZAAR → eBay cross-listing
app.include_router(suppliers_router.router, prefix=PREFIX)  # Supplier Connect (API2Cart)
app.include_router(eats_router.router,      prefix=PREFIX)  # BAZAAR Eats — food & markets
